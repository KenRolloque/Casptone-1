...
// import {StyleSheet, View, Text, Dimensions, Platform,Image, TouchableOpacity, Button } from 'react-native';
...
//   //  camera permissions
//   const [hasCameraPermission, setHasCameraPermission] = useState <any |  null>(null);
//   const [camera, setCamera] = useState<any |  null>(null);
//   const isFocused = useIsFocused();


//   // flashlight
//   const [flashMode, setFlashMode] = useState<keyof typeof Camera.Constants.FlashMode | any>('off');
//   const [buttonColor, setButtonColor] = useState("#00a398")

//   // Zoom
//   const [sliderValue, setSliderValue] = useState(0)
//   const cameraRef2 = useRef <any |  null>(null);
...
//   const manipulateZoom = (value:any) => {
...
//     let desiredRatio:any = '4:3';  // Start with the system default
...
//   } else {
//     return (
//       <View style={scanStyle.mainContainer}>
//         {/* 
